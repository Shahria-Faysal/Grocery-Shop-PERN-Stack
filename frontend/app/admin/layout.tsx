...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen pt-16">
      {/* Sidebar */}
      <aside className="w-56 shrink-0 border-r border-gray-100 bg-white sticky top-16 h-[calc(100vh-4rem)] flex flex-col p-3 gap-1">
        ...
        <div className="mt-auto space-y-1">
          <a href="/">
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition-colors cursor-pointer">
              <ShoppingBag className="h-4 w-4 shrink-0" /> View Store
            </div>
          </a>
